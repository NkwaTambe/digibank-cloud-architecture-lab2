...
@OpenAPIDefinition(
        info = @Info(
                title = "Digi Bank Compliance Service",
                description = "Validates transaction amounts and hosts future KYC/AML rules. "
                        + "Invoked by the Transaction Service before settling a transfer.",
                version = "1.0.0",
